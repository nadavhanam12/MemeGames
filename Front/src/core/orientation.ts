/**
 * Best-effort landscape lock for Android mobile browsers.
 *
 ...
 * there the CSS portrait overlay in index.html is the only guard. So this
...
export function setupLandscapeLock(): void {
  ...
  const tryLock = async () => {
    ...
    try {
      ...
      // Denied or unsupported — the CSS portrait overlay still covers us.
    }
  };
